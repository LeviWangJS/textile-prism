...
class PhotoshopProcessor:
    ...
    def process_image(self, image_path: str) -> Optional[str]:
        ...
        tell application "System Events"
            tell process "Adobe Photoshop 2023"
                -- 显示图层面板
                click menu item "Layers" of menu "Window" of menu bar 1
                delay 1
                
                -- 选择智能对象图层
                click UI element "{self.mockup_template['smart_object']}" of list 1 of group 1 of window "Layers"
                delay 0.5
                click UI element "{self.mockup_template['smart_object']}" of list 1 of group 1 of window "Layers" 2
                delay 1
